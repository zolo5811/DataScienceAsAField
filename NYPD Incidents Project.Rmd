...
## Packages Required
In order to run this analysis, the "EMMEANS" and "TIDYVERSE" packages must be installed. If you do not have these packages installed, then the further analysis won't populate.

\ **Please run: install.packages('emmeans') & install.packages('tidyverse') if having trouble knitting the document.**
